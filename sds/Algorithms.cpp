...
void _tmain(int argc, _TCHAR* argv[])
{
	...
	/*const int Len = 7;
	char infix[Len] = {'D', 'B' , 'E' , 'A', 'F', 'C', 'G'};
	char prefix[Len] = {'A', 'B' , 'D' , 'E', 'C', 'F', 'G'};
	
	IBST<char, char> tree(infix, prefix, Len);
	cout<<tree<<endl;
	cout<<"is Tree symmetric?" <<tree.isSymmetric();*/
	
	//IBST<double,double>::Node* nodes = new IBST<double,double>::Node[10]; 
	//for (int i = 0; i < 10; i++){
	//	double key = rand()%100;
	//	double value = 10;
	//	IBST<double,double>::Node node(key, value);
	//	nodes[i] = node;
	//}

	//IBST<double, double> bstree(nodes, 10);
	//cout<< bstree << endl;

	//cout<<nodes[3].key<<' ';
	//IBST<double, double>::Node* snode = bstree.search(nodes[3].key);
	//if(snode)
	//	cout<<snode->key<<endl;

	//for(int i = 0; i < 10; i++){
	//	cout<<nodes[i].key<<" next node ";
	//	IBST<double,double>::Node* node;
	//	node = bstree.next(&nodes[i]);
	//	if(node)
	//		cout<<node->key<<endl;
	//	else
	//		cout<<"NULL"<<endl;
	...
	//bstree.insert(IBST<double,double>::Node(100, 10));
	//cout<< bstree<<endl;

	//IBST<double, double>::Node* ancestor = bstree.common_ancestor(bstree.search(58), bstree.search(100));
	//if(ancestor)
	//	cout<<ancestor->key<<endl;

	/*for(int i = 0; i < 10; i++){
		cout<< "Remove "<<nodes[i].key;
		bstree.remove(nodes[i].key);
		cout<<bstree<<endl;
	}*/

	// array test
	//int arr[] = { 4, 6, 8, 32, 19,100, 2,24 } ;
 //   ILinkedList<int> dlist (arr);
 //   dlist.push_back(11);
	...
	//cout<<endl<<dlist;
	//cout<< dlist.find(6)<<endl;
	//cout<< dlist.find(11)<<endl;
	//cout<< dlist.get(3)<<endl;
	//cout<< dlist.getLast(3)<<endl;

	//

	////dlist.reverse();
	////cout<<dlist;
	////cout<<"isCorrect? "<<dlist.validata()<<endl;
	//cout<<dlist;
	//dlist.sort();
	//cout<<dlist;
 ...
 //   cout << " " << *it;
	...
	hash_map.insert("siyin", 10);
	hash_map.insert("hello", 5);
	hash_map.insert("siyin", 20);*/
